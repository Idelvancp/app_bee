...
import '../models/typeHive.dart';
import '../models/specie.dart';
import '../models/floralResource.dart';
...
const DUMMY_FLORAL_RESOURCES = [
  FloralResource(id: 1, name: 'Angico'),
  FloralResource(id: 2, name: 'Mameleiro'),
  FloralResource(id: 3, name: 'Faveira'),
];
